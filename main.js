(function(obj) {
    ...
    var model = (function() {
        var fs = new zip.fs.FS(),
            requestFileSystem = obj.webkitRequestFileSystem || obj.mozRequestFileSystem || obj.requestFileSystem,
            URL = obj.webkitURL ||
            obj.mozURL || obj.URL;
    ...
    (function() {
        ...
        function onexport(isFile) {
            ...
            return function(event) {
                var filename, target = event.target,
                    node;
                if (!target.download) {
        ...
        function refreshListing() {
            ...
            node.children.sort(function(a, b) {
                ...
                if (!child.directory) {
                    ...
                    exportFile.className = "fa fa-download";
                    exportFile.hidden = "true";
